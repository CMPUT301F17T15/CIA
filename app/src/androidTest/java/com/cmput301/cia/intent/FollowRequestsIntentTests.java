...
public class FollowRequestsIntentTests extends ActivityInstrumentationTestCase2<HomeTabbedActivity> {

    private Solo solo;

    public FollowRequestsIntentTests() {
        super(HomeTabbedActivity.class);
    }
    ...
    public void setUp() throws Exception{
        ...
        intent.putExtra(HomeTabbedActivity.ID_PROFILE, profiles.get(0));
        ...
        solo.sleep(2000);
        solo.clickOnView(getActivity().getBottomBarTabFromId(R.id.tab_followRequests));
        solo.sleep(3500);
    }
